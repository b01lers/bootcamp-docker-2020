...
nohup sage -n jupyter --NotebookApp.token='' --no-browser --ip='0.0.0.0' --port=8888 > /dev/null 2>&1 &
nohup python3 /web/0-basic_dev_tools/server.py > /dev/null 2>&1 &
nohup python3 /web/1-http_methods/server.py > /dev/null 2>&1 &
nohup python3 /web/2-burp/server.py > /dev/null 2>&1 &
echo "Starting mysqld...sit tight."
nohup mysqld 2>&1 &
nohup php -S localhost:3004 -t /web/4-php/ > /dev/null 2>&1 &
...
$SCRIPTS/wm_startup.sh &> $STARTUPDIR/wm_startup.log
...
echo -e "\nStarted. Connect in your web browser with http://localhost:$NO_VNC_PORT.\nThe password is "password".\n"

echo -e "\nYou can connect to the jupyter notebook for crypto at http://localhost:8888.\n"
